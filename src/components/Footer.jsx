...
export default function Footer() {
  return (
    <footer className="py-12 px-6 border-t border-brand-cyan/10">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-5">
          <a
            href="https://linkedin.com/in/anirban-das-ba655217"
            target="_blank"
          ...
          <a
            href="mailto:das.nayans@gmail.com"
            className="text-brand-muted hover:text-brand-cyan transition-colors"
            aria-label="Email"
          >
            <Mail size={20} />
        ...
        <p className="text-brand-muted text-xs font-mono">
          © {new Date().getFullYear()} Anirban Das. All rights reserved.
        </p>
      </div>
    </footer>
  );
